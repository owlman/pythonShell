...
class TestCreateTranslationProject(unittest.TestCase):
    ...
    @patch('sys.argv', ['create-translation-project', '/tmp/test_project'])
    @patch('create_translation_project.common.print_banner')
    ...
    @patch('sys.argv', ['create-translation-project', '/tmp/test_project', 'my_translation'])
    @patch('create_translation_project.common.print_banner')
    @patch('zipfile.ZipFile')
    @patch('os.path.exists')
    ...
    @patch('sys.argv', ['create-translation-project'])
    @patch('builtins.print')
    def test_missing_arguments(self, mock_print):
        with self.assertRaises(SystemExit):
            create_translation_project.main()
        mock_print.assert_called_with("Usage: create-translation-project <project_directory> [project_name]")

    @patch('sys.argv', ['create-translation-project', '/tmp/test', 'name', 'extra'])
    @patch('builtins.print')
